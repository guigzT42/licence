...
Le recours au travail de nuit est **encadré et limitatif**. Il est justifié ici par la nécessité d'assurer la **continuité de l'activité économique** du magasin — motif expressément prévu par la loi.

**Définition et cadre légal** — articles **L. 3122-1 à L. 3122-24 du code du travail** :

| Thème | Règle |
|---|---|
| **Période de nuit** | Tout travail effectué entre **21 h et 6 h**. Une autre période de neuf heures consécutives comprise entre 21 h et 7 h et incluant obligatoirement l'intervalle **minuit – 5 h** peut être substituée par accord collectif |
| **Recours au travail de nuit** | Doit rester **exceptionnel**, être justifié par la nécessité d'assurer la continuité de l'activité économique ou des services d'utilité sociale (art. L. 3122-1), et prendre en compte les impératifs de protection de la santé et de la sécurité |
| **Mise en place** | Par convention ou accord collectif étendu, ou accord d'entreprise ; à défaut, sur **autorisation de l'inspecteur du travail** après consultation du CSE |
| **Statut de travailleur de nuit** | Salarié accomplissant, au moins deux fois par semaine, au moins **3 heures** de travail durant la période de nuit, **ou** un nombre minimal d'heures sur une période de référence — à défaut d'accord, **270 heures sur 12 mois consécutifs** |
| **Durée quotidienne maximale** | **8 heures**, avec dérogations encadrées par accord ou autorisation de l'inspection du travail |
| **Durée hebdomadaire maximale** | **40 heures** en moyenne sur 12 semaines consécutives (portée à 44 heures par accord) |
| **Contreparties obligatoires** | **Repos compensateur**, éventuellement complété d'une **compensation salariale** |
| **Pauses** | Au moins **20 minutes** consécutives après 6 heures de travail (art. L. 3121-16) |
| **Suivi médical** | **Surveillance médicale renforcée** : visite d'information et de prévention **préalable à l'affectation**, puis suivi périodique par le médecin du travail |
| **Priorité de mutation** | Droit à une affectation sur un poste de jour en cas d'incompatibilité avec des obligations familiales impérieuses ou pour raison de santé |
| **Protections particulières** | **Interdiction absolue du travail de nuit pour les jeunes de moins de 18 ans** (art. L. 3163-2), donc **pour nos apprentis mineurs** ; dispositions spécifiques pour les femmes enceintes (art. L. 1225-9) |
...
Le magasin est un **ERP de type M** (magasins de vente), soumis au **code de la construction et de l'habitation** (articles **R. 143-1 et suivants**) et au **règlement de sécurité contre les risques d'incendie et de panique** approuvé par l'**arrêté du 25 juin 1980**, complété par les dispositions particulières au type M (**arrêté du 22 décembre 1981**).

**a) L'article GN 13 — travaux dans un ERP en exploitation**

L'article **GN 13** de l'arrêté du 25 juin 1980 pose le principe fondamental : **l'exploitant ne peut pas exécuter ou faire exécuter des travaux qui mettraient le public en danger ou entraveraient l'évacuation de l'établissement**. Il en découle une série d'obligations que nous avons appliquées :
...
**b) Les exigences techniques du règlement de sécurité applicables à notre ouvrage**

Les installations de chauffage, ventilation et climatisation en ERP sont régies par les **articles CH** du règlement de sécurité. Les points qui nous concernaient directement :
...
**70 % du chantier a été réalisé en nacelle** : c'est le risque numéro un de l'opération, et celui qui a le plus structuré l'organisation.

**a) Le cadre réglementaire**

| Thème | Référence | Contenu |
|---|---|---|
| Priorité à la protection collective | **Art. R. 4323-58 du code du travail** | Les travaux temporaires en hauteur doivent être réalisés à partir d'un **plan de travail** conçu pour garantir la sécurité — d'où le choix de la **PEMP** plutôt que de l'échelle ou de l'échafaudage roulant |
| Interdiction des échelles comme poste de travail | **Art. R. 4323-63** | Les échelles ne peuvent être utilisées comme poste de travail que par exception, lorsqu'aucun autre moyen n'est envisageable |
| Autorisation de conduite | **Art. R. 4323-56** | L'employeur délivre une **autorisation de conduite** après formation adéquate, examen d'aptitude médicale et connaissance des lieux et instructions |
| Certificat de compétence | **Recommandation CNAM R. 486** | **CACES® R486**, catégorie **A** (élévation verticale) ou **B** (élévation multidirectionnelle), selon le type de nacelle utilisé |
| Vérifications de l'équipement | **Arrêté du 1<sup>er</sup> mars 2004** | **Vérification générale périodique tous les 6 mois**, vérification de mise en service, **examen d'adéquation** avant utilisation, tenue du registre de sécurité de l'appareil |
| Protection individuelle | | Port du **harnais antichute** avec **longe courte** reliée au point d'ancrage de la nacelle, notamment sur les PEMP à élévation multidirectionnelle (risque d'**effet catapulte**) |
...
5. **Personne au sol formée aux manœuvres de secours** : c'est une exigence essentielle et souvent négligée. Le binôme permettait en permanence d'avoir **une personne capable de descendre la nacelle depuis les commandes de secours** en cas de malaise de l'opérateur en hauteur. La procédure de secours a été définie **avant** le début du chantier.
6. **Interdiction absolue** de sortir de la nacelle en hauteur, de s'appuyer sur les garde-corps ou d'utiliser un moyen d'élévation complémentaire dans le panier.
7. **Gestion des chutes d'objets** : outillage attaché, zone au sol interdite et balisée, seau à outils, casque avec jugulaire.
8. **Coordination des deux nacelles** 〈si deux appareils ont été utilisés simultanément〉 : distances de sécurité, communication par radio ou à vue.

### 3.7.5 Les autres risques identifiés et les mesures associées
...
Le dossier de sécurité du chantier rassemble : l'**analyse de risques et le mode opératoire** (responsable chantier + QSE) ; le **plan de prévention** établi avec le magasin ; le **permis de feu**, renouvelé selon la périodicité définie ; les **autorisations de conduite de nacelle** et les **attestations CACES® R486** ; les **habilitations électriques** ; les **attestations d'aptitude à la manipulation des fluides frigorigènes** ; les **rapports de vérification générale périodique de la nacelle**, contrôlés à la livraison ; les **fiches de données de sécurité** (fluide, azote, produits), disponibles sur le chantier ; le **registre de sécurité du magasin**, renseigné à chaque intervention impactante ; enfin les **consignes de sécurité du site et les numéros d'urgence**, diffusés à l'équipe. Les principaux de ces documents sont à joindre en annexe du rapport définitif.
