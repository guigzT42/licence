...
SRC = sorted(glob.glob(os.path.join(os.path.dirname(__file__), '0*.md')))
OUT = os.path.join(os.path.dirname(__file__), 'Rapport_Bloc4_VRV_Intermarche_Rive-de-Gier.docx')
