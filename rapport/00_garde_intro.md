...
## Bloc 4 — Initiation et coordination de projets de transition énergétique
...
**Organisme de formation :** IRUP — Institut Régional Universitaire Polytechnique, Saint-Étienne (42)
...
| Sigle | Signification |
|---|---|
| BACS | *Building Automation and Control Systems* — systèmes d'automatisation et de contrôle des bâtiments |
| CEE | Certificats d'Économies d'Énergie |
| COP / SCOP | *Coefficient of Performance* / *Seasonal COP* — rendement d'une PAC en chauffage |
...
## Introduction et démarche du rapport

Ce rapport est présenté dans le cadre du **Bloc 4 — « Initiation et coordination de projets de transition énergétique »** de la **licence professionnelle Chargé de Projet Énergie et Bâtiment Durables (CPEBD)**, suivie en alternance à l'**IRUP de Saint-Étienne**. Il s'appuie sur une situation professionnelle réelle, vécue en tant que salarié de l'entreprise **Santerne Surfaces Commerciales**, filiale du groupe **VINCI Energies** implantée à La Talaudière (Loire).
