# Kit soutenance — Bloc 4
## Projet VRV Intermarché Rive-de-Gier — Guillaume TARDY (Licence CPEBD, IRUP Saint-Étienne)

*Document de travail personnel, non destiné à être remis avec le rapport.*

## Annexe D — Trame de la soutenance orale (20 min + 10 min de questions)

La grille d'évaluation de la soutenance pondère les critères de la façon suivante ; la trame ci-dessous répartit le temps en conséquence.

| Séquence | Durée | Contenu | Coef. grille |
|---|---|---|---|
...
| 9. Questions | 10 min | Voir annexe E | |

**Recommandations pour le support** : une idée par diapositive, des visuels réels (photos de nuit, schéma de principe, plan d'implantation), des chiffres clés lisibles à distance, un fil rouge visible (numéro d'étape), pas de texte rédigé.

## Annexe E — Questions probables du jury et éléments de réponse
...
## Annexe B — Pièces à joindre au rapport définitif
