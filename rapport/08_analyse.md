...
**5. L'écart entre le budget de l'audit et le devis réel (− 27 %) n'a pas été exploité.** Passer de 122 800 € à 90 000 € améliore le temps de retour de 21,5 à 15 ans après CEE : ce recalcul aurait dû être présenté au client, c'était un argument commercial gratuit.

**6. Le chiffrage du travail de nuit a été sous-évalué d'un facteur deux — et le bon résultat final ne doit pas le masquer.** Le temps de nuit réellement consommé a été **environ le double du prévisionnel** (analyse en 3.9.2), absorbé par l'entreprise et non par le client. La cause n'est pas un incident mais une **méthode de chiffrage inadaptée** : des temps de pose de chantier de jour appliqués à un chantier de nuit, sans budgéter le temps improductif quotidien d'installation et de repli, ni appliquer de coefficient de productivité nocturne.
> L'affaire s'est pourtant terminée **très légèrement bénéficiaire**, grâce aux **économies sur les achats et à la négociation fournisseurs**. C'est un bon résultat, mais il faut résister à la tentation d'en conclure que tout allait bien : **la marge prévue a été consommée**, et la compensation est venue d'un levier ponctuel et non reproductible. Un résultat positif ne valide pas une estimation fausse — le croire, c'est reconduire l'erreur sur l'affaire suivante. La correction est simple et je la porterai sur mes prochains devis : **distinguer au chiffrage le temps de production du temps de mise en place et de repli**, et appliquer un coefficient explicite au travail en nacelle en site occupé.
...
**8. La mesure de la satisfaction client n'a pas été formalisée** : le retour est bon, mais oral. Une enquête écrite en fin d'opération aurait produit un élément valorisable commercialement.
...
**Sur le plan de la gestion de projet** : le passage d'une logique de **tâche** à une logique de **projet** (objectifs, parties prenantes, planning, risques, indicateurs) ; l'apprentissage — **par l'erreur** — du chiffrage d'un chantier atypique (nuit, hauteur, site occupé), et la découverte que **le déboursé achat est un levier de marge aussi puissant que la productivité du chantier** ; enfin l'apprentissage de la **conduite d'un client** : convaincre ne consiste pas à énoncer des arguments techniques, mais à traduire un enjeu technique dans le langage du décideur — euros, risques, image, continuité d'exploitation.
...
Ce parcours illustre ce que le bloc 4 cherche à évaluer : **une problématique réelle**, objectivée par un audit IPMVP qui a chiffré l'écart à combler (**330,6 kWh/m²/an contre 221,5 exigés en 2030**) ; **un argumentaire construit**, croisant technique, économie, environnement et réglementation — décret tertiaire, BACS, lois APER et LOM, règlement F-Gas — pour montrer à un décideur que **l'inaction a un coût** ; **des objectifs formalisés**, un **budget détaillé**, un **financement CEE** et un **calendrier** tenu ; **une planification sous contraintes fortes** (fenêtre de huit heures, ERP en exploitation, 70 % des tâches en nacelle) ; et **une évaluation finale** assortie d'indicateurs d'impact et d'une **analyse critique** assumée — le fluide R-410A, un temps de retour de quinze ans, un temps de nuit doublé et une marge sauvée par les achats plutôt que par la méthode.

Mon niveau d'intervention, je l'ai dit clairement : j'ai **participé** à l'audit sans en être l'auteur et **réalisé une partie** du chantier sans en avoir été le chef. C'est précisément ce qui rend ce projet formateur : il m'a fait passer du poste de **chargé de maintenance** — entretiens, dépannages, devis de remplacement de petites installations — au rôle de contributeur d'un projet de transition énergétique à 90 000 €. Car **le rôle d'un chargé de projet en transition énergétique n'est pas de proposer la meilleure solution technique, mais de rendre une solution possible** : acceptable économiquement, réalisable pour l'équipe, sûre pour les compagnons et conforme pour le bâtiment.
